...
var aText = new Array("<b>UNITED</b> Group is a one of the oldest and largest supplier of the power tools for industrial and commercial wing, they are serving since <b>1935</b>, having lots of experience in power tools distribution and engineering funtionality about tools keeps them in first position always, and provides best of the best service among other competitor.");
var iSpeed = 50; //time delay of the print out
var iIndex = 0; //start printing the array at this position
var iArrLength = aText[0].length; // the length of the array of the text
var iScrollAt = 20; // start scrolling up at this many lines

var iTextPos = 0;  // initialize the text position
var sContents = ''; // initialize the contents variable
var iRow; //    initialize current row

// function of the tyepewriter starts 
